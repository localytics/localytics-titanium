...
{
	// Profiles
	@Kroll.constant public static final String PROFILE_SCOPE_ORG = "org";
	@Kroll.constant public static final String PROFILE_SCOPE_APP = "app";
	...
	@Kroll.method
	public void tagEvent(String eventName, @Kroll.argument(optional=true) Map attributes, @Kroll.argument(optional=true) long customerValueIncrease)
	{
	...
	@Kroll.method
	public void setProfileAttribute(String attributeName, Object attributeValue, @Kroll.argument(optional=true) String scope)
	{
	...
	@Kroll.method
	public void addProfileAttributesToSet(String attributeName, Object attributeValue, @Kroll.argument(optional=true) String scope)
	{
	...
	@Kroll.method
	public void removeProfileAttributesFromSet(String attributeName, Object attributeValue, @Kroll.argument(optional=true) String scope)
	{
		if (attributeValue instanceof Object[])
		{
			Object[] cast = (Object[]) attributeValue;
	...
	@Kroll.method
	public void incrementProfileAttribute(String attributeName, long incrementValue, @Kroll.argument(optional=true) String scope)
	{
		Localytics.incrementProfileAttribute(attributeName, incrementValue, Utils.getProfileScope(scope));
	}
	
	@Kroll.method
	public void decrementProfileAttribute(String attributeName, long incrementValue, @Kroll.argument(optional=true) String scope)
	{
	...
	{
		Localytics.setPushDisabled(disable);
	}
	
	@Kroll.method
	public boolean isPushDisabled()
	{
		return Localytics.isPushDisabled();
	}
	...
	@Kroll.method
	public void setSessionTimeoutInterval(long seconds)
	{
